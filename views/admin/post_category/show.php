					    ...
					    <tbody>
					    	<?php
					    		...
					    		<tr>
					    			...
					    			<td><a href="dashboard.php?page=post_category&action=edit&id=<?= $cate->post_category_id?>"
					    				class="btn btn-warning">Chỉnh sửa</a> 
					    				<a href="dashboard.php?page=post_category&action=delete&id=<?= $cate->post_category_id ?>"
					    				onclick="return confirm('Nhóm bài đăng sẽ bị xóa vĩnh viễn?');"
